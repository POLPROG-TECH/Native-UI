...
export const WithIcon: Story = {
  ...
  render: () => (
    <VStack gap="md" style={{ alignItems: 'flex-start' }}>
      <Button title="Add Item" icon={<RNText style={{ fontSize: 16 }}>＋</RNText>} onPress={fn()} />
      <Button
        title="Delete"
        variant="danger"
...
export const WithGlow: Story = {
  ...
  render: () => (
    <VStack gap="lg" style={{ maxWidth: 360 }}>
      ...
      <VStack gap="sm">
        <Text variant="label" color="textSecondary">
          glow suppressed while disabled
        </Text>
  ...
  render: () => (
    <VStack gap="md" style={{ maxWidth: 280 }}>
      ...
      <Button
        ...
        onPress={fn()}
      />
      <Button title="Full width + long title avoids horizontal overflow" fullWidth onPress={fn()} />
    </VStack>
  ),
};
