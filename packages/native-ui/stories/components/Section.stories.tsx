...
export const WithAction: Story = {
  ...
  render: () => (
    <Section
      ...
      action={<Button title="See All" variant="ghost" size="sm" onPress={sbAction('seeAll')} />}
      style={{ maxWidth: 400 }}
    >
      <Card>
        <Text variant="body" color="textSecondary">
...
export const MultipleSections: Story = {
  ...
  render: () => (
    <VStack gap="xl" style={{ maxWidth: 400 }}>
      <Section
        title="This Month"
        action={<Button title="Details" variant="ghost" size="sm" onPress={sbAction('details')} />}
      >
        <Card>
          <VStack gap="xs">
      ...
      <Section title="Recent">
        <VStack gap="sm">
          <Card>
            <Text variant="body">Entry 1</Text>
          </Card>
          <Card>
            <Text variant="body">Entry 2</Text>
          </Card>
        </VStack>
      </Section>
    </VStack>
