...
export const FullScale: StoryObj = {
  ...
  render: () => {
    ...
    return (
      <View>
        <RNText
          style={{ fontSize: 20, fontWeight: '700', color: colors.textPrimary, marginBottom: 20 }}
        >
          Display
        </RNText>
    ...
    return (
      <View>
        <RNText style={{ fontSize: 14, color: colors.textSecondary, marginBottom: 24 }}>
          native-ui supports 3 font scale levels for accessibility. Each level adds pixels to the
          base font size.
        </RNText>
        {Object.entries(FONT_SCALE).map(([level, adjustment]) => (
          ...
          >
            ...
            <RNText
              style={{
                fontSize: typography.body.fontSize + adjustment,
                lineHeight: typography.body.lineHeight + adjustment,
                color: colors.textPrimary,
              }}
            >
            ...
            <RNText
              style={{
                fontSize: typography.h2.fontSize + adjustment,
                fontWeight: '600',
                marginTop: 8,
                color: colors.textPrimary,
              }}
    ...
    return (
      <View>
        <RNText style={{ fontSize: 14, color: colors.textSecondary, marginBottom: 16 }}>
          Compare all typography variants at a glance. Each row shows the variant name, specs, and a
          text sample.
        </RNText>
        <View
          style={{
        ...
        >
          ...
          >
            <RNText
              style={{ width: 140, fontSize: 12, fontWeight: '600', color: colors.textSecondary }}
            >
              Variant
            </RNText>
            <RNText
              style={{ width: 60, fontSize: 12, fontWeight: '600', color: colors.textSecondary }}
            >
              Size
            </RNText>
            <RNText
            ...
            <RNText
              style={{ flex: 1, fontSize: 12, fontWeight: '600', color: colors.textSecondary }}
            >
              Preview
            </RNText>
          </View>
            ...
            .map((variant, i) => {
              ...
              return (
                ...
                >
                  ...
                  <RNText style={{ width: 60, fontSize: 12, color: colors.textSecondary }}>
                    {t.fontSize}px
                  </RNText>
                  <RNText style={{ width: 60, fontSize: 12, color: colors.textSecondary }}>
                    {t.lineHeight}px
                  ...
                  <RNText style={{ flex: 1, ...t, color: colors.textPrimary }} numberOfLines={1}>
                    Abc 123
                  </RNText>
                </View>
              );
...
const CompactVsRegularRow = ({ variant }: { variant: TypographyVariant }) => {
  ...
  return (
    ...
    >
      <RNText
        style={{ width: 130, fontSize: 12, fontFamily: 'monospace', color: colors.textPrimary }}
      >
        {variant}
      </RNText>
      <View style={{ flex: 1 }}>
        <RNText
          style={{
            ...
            lineHeight: reg.lineHeight,
            fontWeight: reg.fontWeight as any,
            color: colors.textPrimary,
          }}
          numberOfLines={1}
        >
      ...
      <View style={{ flex: 1 }}>
        <RNText
          style={{
            ...
            fontWeight: com.fontWeight as any,
            color: colors.primary,
          }}
          numberOfLines={1}
        >
      ...
      <RNText
        style={{
          ...
          fontSize: 11,
          fontFamily: 'monospace',
          color: delta === 0 ? colors.textTertiary : delta > 0 ? colors.success : colors.error,
          textAlign: 'right',
        }}
      >
        Δ {deltaLabel}
